 ...
 */
function getImageSizes(layout: 2 | 3 = 2, containerPadding: number = 15, gap: number = 15) {
  ...
  if (layout === 3) {
    ...
    imageWidth = (availableWidth - GAP) / 3;
  }
...
// React hook function
function useImageSize(layout: 2 | 3 = 2, containerPadding: number = 15, gap: number = 15) {
